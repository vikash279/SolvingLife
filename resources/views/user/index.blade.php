      ...
      <div class="row  mb_30">
         <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-danger card-img-holder text-white">
               <div class="card-body">
                  ...
                  <h4 class="font-weight-normal mb-3">Total Team <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5">1</h2>
               </div>
            </div>
         ...
         <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-info card-img-holder text-white">
               <div class="card-body">
                  <img src="{!!asset('public/assets/img/circle.svg')!!}" class="card-img-absolute" alt="circle-image">
                  <h4 class="font-weight-normal mb-3">Active Team <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5">0</h2>
               </div>
            </div>
