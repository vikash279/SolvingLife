   ...
   <body class="crm_body_bg">
      <nav class="sidebar">
         <div class="logo d-flex justify-content-between">
            <a class="large_logo" href="{{url('dashboard')}}"><img src="{!!asset('assets/img/logo.png')!!}" alt=""></a>
            <a class="small_logo" href="{{url('dashboard')}}"><img src="{!!asset('assets/img/mini_logo.png')!!}" alt=""></a>
